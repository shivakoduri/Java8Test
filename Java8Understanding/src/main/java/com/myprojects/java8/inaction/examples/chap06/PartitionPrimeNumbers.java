...
//        return primes.stream().takeWhile(i->i<=candidateRoot).noneMatch(i -> candidate%i ==0);0
    }
    ...
    private static Map<Boolean, List<Integer>> partitionPrimesWithCustomCollector(int i){
        return IntStream.rangeClosed(2, i).boxed().collect(new PrimeNumbersCollector());
    }
