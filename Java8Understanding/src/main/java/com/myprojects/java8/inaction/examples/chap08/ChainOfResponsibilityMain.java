...
public class ChainOfResponsibilityMain {
    ...
    public static void main(String... args){
        ...
        String result = p1.handle("Aren't labdas really easy !");
        System.out.println(result);

        UnaryOperator<String> headerProcessing = (String text) -> "From Raoul, Mario and Alan:" + text;
        UnaryOperator<String> spellCheckerProcessing = (String text) -> text.replaceAll("labda", "lambda");
        Function<String, String> pipleline = headerProcessing.andThen(spellCheckerProcessing);
        String result2 = pipleline.apply("Aren't labdas really easy.!");
    ...
    static private class HeaderTextProcessing extends  ProcessingObject<String>{
        ...
        protected String handleWork(String text) {
            return "Fram Raoul, Mario and Alan:" + text;
        }
    }
