...
public class CollectingAndReducing {
     ...
     */
    public static Double averageAge(List<Personfrm5> persons) {
        return persons.stream()
                .mapToInt(Personfrm5::getAge)
                .average().getAsDouble();
     ...
     */
    public static Integer maxAge(List<Personfrm5> persons) {
        return persons.stream()
                .mapToInt(Personfrm5::getAge)
                .max().getAsInt();
    }
     ...
     */
    public static IntSummaryStatistics ageStatistics(List<Personfrm5> persons) {
        return persons.stream()
                .mapToInt(Personfrm5::getAge)
                .summaryStatistics();
    }
     ...
     */
    public static String buildCommaSeparatedListOfFirstNames(List<Personfrm5> persons) {
        return persons.stream()
                .map(Personfrm5::getFirstName)
